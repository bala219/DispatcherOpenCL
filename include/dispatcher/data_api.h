...
#ifndef EXEC_ENGINE_COMPARISON_DATA_API_H
#define EXEC_ENGINE_COMPARISON_DATA_API_H
...
namespace dispatcher{
    ...
    void add_data(string alias, T *data, cl_device_id device, size_t size,size_t m = 1){
        ...
        if(err !=CL_SUCCESS){
            cerr<<"Error on Write buffers- "<<alias <<" ( "<<err<<" )"<<endl;
//        exit(0);
        }
...
#endif //EXEC_ENGINE_COMPARISON_DATA_API_H
